...
@section('title', 'Iniciar Sesión - Incidex')
                        ...
                        <div>
                            ...
                            <div class="space-y-6">
                                <h2 class="text-4xl font-bold text-white leading-tight">
                                    Bienvenido a
                                    <span class="bg-gradient-to-r from-primary-400 to-primary-500 bg-clip-text text-transparent">Incidex</span>
                                </h2>
                            ...
                            <form class="space-y-6" id="loginForm" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}" class="text-sm text-primary-400 hover:text-primary-300 transition duration-200">
                                ...
                                <div class="bg-surface-800/50 rounded-xl p-4 border border-surface-700">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div id="statusInfo" class="max-h-0 opacity-0 overflow-hidden transition-all duration-400 mt-2">
