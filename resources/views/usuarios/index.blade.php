...
@section('content')
        ...
        <div class="mb-6">
            <div class="border-b border-surface-700">
                <nav class="-mb-px flex space-x-8 overflow-x-auto">
                    <!-- Tab Todos -->
                    <a href="{{ route('gestion-usuarios.index', ['tab' => 'todos'] + request()->except('tab')) }}"
                       class="py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap {{ $tab == 'todos' ? 'border-primary-500 text-primary-400' : 'border-transparent text-surface-400 hover:text-surface-300' }}">
                    ...
                    <!-- Tab Usuarios -->
                    <a href="{{ route('gestion-usuarios.index', ['tab' => 'usuarios'] + request()->except('tab')) }}"
                       class="py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap {{ $tab == 'usuarios' ? 'border-primary-500 text-primary-400' : 'border-transparent text-surface-400 hover:text-surface-300' }}">
                    ...
                    <!-- Tab Técnicos -->
                    <a href="{{ route('gestion-usuarios.index', ['tab' => 'tecnicos'] + request()->except('tab')) }}"
                       class="py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap {{ $tab == 'tecnicos' ? 'border-primary-500 text-primary-400' : 'border-transparent text-surface-400 hover:text-surface-300' }}">
                    ...
                    <!-- Tab Administradores -->
                    <a href="{{ route('gestion-usuarios.index', ['tab' => 'supervisores'] + request()->except('tab')) }}"
                       class="py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap {{ $tab == 'supervisores' ? 'border-primary-500 text-primary-400' : 'border-transparent text-surface-400 hover:text-surface-300' }}">
                    ...
                    <!-- Tab Pendientes -->
                    <a href="{{ route('gestion-usuarios.index', ['tab' => 'pendientes'] + request()->except('tab')) }}"
                       class="py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap {{ $tab == 'pendientes' ? 'border-primary-500 text-primary-400' : 'border-transparent text-surface-400 hover:text-surface-300' }}">
                    ...
                    <!-- Tab Suspendidos -->
                    <a href="{{ route('gestion-usuarios.index', ['tab' => 'suspendidos'] + request()->except('tab')) }}"
                       class="py-4 px-1 border-b-2 font-medium text-sm flex items-center space-x-2 whitespace-nowrap {{ $tab == 'suspendidos' ? 'border-primary-500 text-primary-400' : 'border-transparent text-surface-400 hover:text-surface-300' }}">
                        ...
                        <tr class="text-sm hover:bg-surface-800/30 transition duration-200">
                            ...
                            <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        {{ $usuario->rol == 'admin' ? 'bg-red-500/20 text-red-400 border border-red-500/30' :
                                           ($usuario->rol == 'tecnico' ? 'bg-purple-500/20 text-purple-400 border border-purple-500/30' :
                            ...
                            <td class="px-6 py-4">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        {{ $usuario->estado == 'activo' ? 'bg-green-500/20 text-green-400 border border-green-500/30' :
                                           ($usuario->estado == 'pendiente' ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/30' :
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end space-x-2">
                                    <!-- Botón Estado -->
                                    @if($usuario->estado == 'activo')
                                        <button onclick="cambiarEstado({{ $usuario->id }}, 'suspendido')"
                                    ...
                                    @elseif($usuario->estado == 'suspendido')
                                        <button onclick="cambiarEstado({{ $usuario->id }}, 'activo')"
                                                class="p-2 text-surface-400 hover:text-green-400 transition duration-200 rounded-lg hover:bg-green-400/10"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12">
                                <div class="text-center">
                                    ...
                                    <button id="btn-crear-primer-usuario"
    ...
    <script>
        ...
        function confirmarEliminacion(usuarioId, usuarioNombre) {
            console.log('Confirmando eliminación para:', usuarioNombre);
