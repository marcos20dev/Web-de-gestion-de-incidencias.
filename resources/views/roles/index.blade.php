...
@section('content')
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div class="flex flex-col sm:flex-row gap-4 flex-1">
                        ...
                        <div class="flex-1">
                            <div class="relative">
                                <i
                                    class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-surface-400"></i>
                        ...
                        <!-- Filtro por Tipo -->
                        <select
                            class="px-4 py-3 bg-surface-800 border border-surface-600 rounded-xl text-white focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30 transition duration-200">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <!-- Botón Nuevo Rol -->
                        <button type="button" id="btn-nuevo-rol"
                            ...
                            <tr class="text-sm hover:bg-surface-800/30 transition duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        <div
                                            ...
                                            <i
                                                class="fas fa-user-tag {{ $rol->isSystemDefault() ? 'text-blue-400' : 'text-purple-400' }}"></i>
                                        </div>
                                        <div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-2">
                                        <span class="text-white font-medium">{{ $rol->users->count() }}</span>
                                        <span class="text-surface-400 text-xs">usuarios</span>
                                    </div>
                                </td>

                                <td class="px-6 py-4 text-surface-300">
                                    {{ $rol->created_at?->format('d/m/Y') ?? 'Sin fecha' }}
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        @if (!$rol->isSystemDefault())
                                            <button
                                                onclick="abrirModalEditar({{ $rol->id_roles }}, '{{ $rol->nombre }}')"
                                        ...
                                        <!-- Botón Permisos -->
                                        <!-- Botón Permisos -->
                                        <a href="{{ route('gestion-roles.show', $rol->id_roles) }}"
                                            class="p-2 text-surface-400 hover:text-blue-400 transition duration-200 rounded-lg hover:bg-blue-400/10"
                                        ...
                                        @if (!$rol->isSystemDefault())
                                            <button
                                                onclick="confirmarEliminacion({{ $rol->id_roles }}, '{{ $rol->nombre }}')"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12">
                                    <div class="text-center">
                                        <div
                                            class="w-24 h-24 mx-auto mb-4 bg-surface-800/50 rounded-full flex items-center justify-center">
    ...
    <div id="modal-crear" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
        style="display: none;">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nombre"
                            ...
                            placeholder="Ej: supervisor, auditor, etc." required>
                    </div>
    ...
    <div id="modal-editar" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
        style="display: none;">
        <div class="glass-effect rounded-2xl p-6 border border-surface-700 max-w-md w-full mx-4">
            <div class="flex items-center justify-between mb-4">
            ...
            <form id="form-editar" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        <label for="nombre_edit" class="block text-sm font-medium text-white mb-2">Nombre del Rol
                            *</label>
    ...
    <div id="modal-eliminar" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
        style="display: none;">
        <div class="glass-effect rounded-2xl p-6 border border-surface-700 max-w-md w-full mx-4">
            <div class="text-center">
                ...
                <p class="text-surface-400 mb-4">Esta acción no se puede deshacer. El rol <span id="nombre-rol"
                        class="font-medium text-white"></span> se eliminará permanentemente.</p>
